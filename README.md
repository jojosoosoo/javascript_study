...
- 자바스크립트에서 웹 페이지에 있는 HTML 요소를 추가, 수정, 삭제하는 방법
...
- 자바스크립트에서 HTML 요소의 내용을 가져오는 데에는 두 가지
  - innerHTML
  - innerText
...
```html
<body>
  <img id="image" src="images/image-3.png" alt="기본이미지" />
...
// 이미지 변경 함수
function changeImg() {
  $("#image").attr("src", "images/image-2.png");
}
